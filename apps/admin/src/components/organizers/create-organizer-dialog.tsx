...
import { Building2, Calendar, FileText, Image, Plus, User } from "lucide-react";
...
export function CreateOrganizerDialog({
    ...
    onCreated?: () => void;
    leaderOptions?: { id: number; name: string | null; email: string }[];
    ...
    const [leaderAdminUserId, setLeaderAdminUserId] = useState("");
        ...
        try {
            ...
            if (!res.ok) {
                ...
                if (msg.includes("Missing fields")) {
                    ...
                    setErrors((prev) => ({
                        ...prev,
                        form: "Iltimos, majburiy maydonlarni to‘ldiring.",
                    }));
                    return;
                }
                if (msg.includes("Invalid foundedAt")) {
                    setErrors((prev) => ({
                        ...prev,
                        form: "Tashkil topgan sana noto‘g‘ri.",
                    }));
                    return;
                }
                throw new Error(msg || "Failed to create organizer");
            }
            ...
            setErrors({});
            onCreated?.();
            toastSuccess("Tashkilotchi yaratildi ✅");
            router.refresh();
        } catch (e) {
        ...
        >
            <DialogTrigger asChild>
                <Button>
                    ...
                    Tashkilotchi yaratish
                </Button>
            </DialogTrigger>

            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    <DialogTitle>Yangi tashkilotchi</DialogTitle>
                </DialogHeader>
